  ...
  return new Promise((resolve, reject) => {
    ...
    npr.one.authorization
      ...
      .then((res) => {
        ...
        console.log('0Access Token: ' + process.env.NPR_ACCESS_TOKEN);
...
exports.getToken = (api) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    if(process.env.NPR_ACCESS_TOKEN) {
        console.log('1Access Token: ' + process.env.NPR_ACCESS_TOKEN);
    ...
    getClientCreds()
      ...
      .then((token) => {
        ...
        console.log('2Access Token: '+process.env.NPR_ACCESS_TOKEN);
        resolve(token);
      })
      .catch(reject);
